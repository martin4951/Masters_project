...
void ADC_DeInit(void)
{
  ...
  RCC_APB2PeriphResetCmd(RCC_APB2Periph_ADC, _ENABLE);

  /* Release all ADCs from reset state */
  RCC_APB2PeriphResetCmd(RCC_APB2Periph_ADC, _DISABLE);
}
...
void ADC_StructInit(ADC_InitTypeDef* ADC_InitStruct)
{
  ...
  ADC_InitStruct->ADC_ScanConvMode = _DISABLE;

  /* Initialize the ADC_ContinuousConvMode member */
  ADC_InitStruct->ADC_ContinuousConvMode = _DISABLE;
...
FlagStatus ADC_GetSoftwareStartConvStatus(ADC_TypeDef* ADCx)
{
  ...
  if ((ADCx->CR2 & ADC_CR2_SWSTART) != (uint32_t)_RESET)
  {
    /* SWSTART bit is set */
    bitstatus = _SET;
  }
...
uint32_t ADC_GetMultiModeConversionValue(void)
{
  ...
  return (*(__vo uint32_t *) CDR_ADDRESS);
}
/**
  * @}
  */
 ...
 *(__vo uint32_t *) tmp = (uint32_t)Offset;
}
...
FlagStatus ADC_GetSoftwareStartInjectedConvCmdStatus(ADC_TypeDef* ADCx)
{
  ...
  if ((ADCx->CR2 & ADC_CR2_JSWSTART) != (uint32_t)_RESET)
  {
    /* JSWSTART bit is set */
    bitstatus = _SET;
  }
...
uint16_t ADC_GetInjectedConversionValue(ADC_TypeDef* ADCx, uint8_t ADC_InjectedChannel)
{
  ...
  return (uint16_t) (*(__vo uint32_t*)  tmp);
}
/**
  * @}
  */
...
FlagStatus ADC_GetFlagStatus(ADC_TypeDef* ADCx, uint8_t ADC_FLAG)
{
  ...
  if ((ADCx->SR & ADC_FLAG) != (uint8_t)_RESET)
  {
    /* ADC_FLAG is set */
    bitstatus = _SET;
  }
...
ITStatus ADC_GetITStatus(ADC_TypeDef* ADCx, uint16_t ADC_IT)
{
  ...
  if (((ADCx->SR & itmask) != (uint32_t)_RESET) && enablestatus)
  {
    /* ADC_IT is set */
    bitstatus = _SET;
  }
